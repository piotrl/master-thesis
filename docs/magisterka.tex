...
\chapter{Import danych}
    ...
    oba są popularne w swojej klasie oraz dostarczają publiczne API dla danych użytkownika.
        ...
        \section*{Last.fm}
            ...
            Serwis udostępnia szereg metod REST API \cite{lastfm:apidoc},
            ...
            Pierwszy sposób jest preferowany, gwarantujący unikalność identyfikatora oraz uniknięcie problemów kodowania znaków.
