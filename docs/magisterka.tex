...
\begin{abstract}
    ...
    wdrożoną na chmurze Digital Ocean pod adresem \url{http://mgr.piotrl.net}
...
\section{Stos technologiczny}
    ...
    aplikacja działa w konterzenrze Tomcat 8.5, a dane przechowywane są w PostgreSQL 9.5
