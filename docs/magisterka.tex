...
\chapter{Analiza danych}
    ...
    Najważniejszą tabelą wśród tych powiązanych z RescueTime jest rescuetime_activity,
    ...
    rescuetime_action oraz rescuetime_category lub tworzone nowe w razie konieczności.

    \begin{table}
    \begin{tabular}
    id      &   account_id   &   start_time   &   end_time   &   productivity   &   spent_time   &   action_id   &   activity_name   &   category_id   &   category_name
    14226   &   1   &   2017-01-31 09:20:00.000000 +01:00   &   2017-01-31 09:25:00   &   2   &   2   &   138   &   evernote.com   &   17   &   Writing
    \end{tabular}
    \caption{
                Przykładowy rekord z tabeli rescuetime_activity
            }
