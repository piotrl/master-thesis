...
\chapter{Analiza danych}
	...
	Gdy pierwsze dane zaczęły się pojawiać w systemie, można zacząć szukać ich sensownego zastosowania.
	Na początku chciałbym zobrazować skalę ilosci danych po jakiej się poruszamy. 
	Zaimportowane dane są z okresu od 31 stycznia do 4 maja 2017 z aktywnosci wykonywanych na prywatnym laptopie oraz od 3 lutego do 4 maja 2017 ze słuchanej muzyki na wielu urządzeniach (prywatny laptop, telefon, służbowy komputer). 
	
	W tym 3 miesięcznym okresie, wykonałem 30664 akcji, które są przypisane do 1916 programów lub stron internetowych z podziałem na 62 kategorie. Łącznie 498 godzin, srednio 5.5 godziny dziennie. 
	
	W przypadku muzyki - przesłuchałem 5203 piosenek, z czego 2303 były unikalne wsród 1155 artystów. Odsłuchane piosenki były przypisane przez społecznosć last.fm do 1185 różnych tagów - najpopularniejsze z nich to: rock, polish, soundtrack.
